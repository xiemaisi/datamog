...
| [`semantic-types.md`](./semantic-types.md) | inference, typed operands and structural contracts implemented | Structured JSON types, nominal proof signatures, projection presence, and storage separation |
