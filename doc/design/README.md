...
behaviour: one records a design that was turned down, three are superseded or partly so, two describe nothing built yet, and
...
| [`null.md`](./null.md) | superseded by `null-as-a-value.md`; four arguments corrected in place | Why there is a NULL at all, how it propagates, why comparison is total and there is one equality |
